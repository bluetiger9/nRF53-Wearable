...
class MAX30105 {
 public: 
  ...
  bool begin(const device *i2c_dev, uint8_t i2c_addr = MAX30105_ADDRESS);
 ...
 private:
  const device *_i2cPort; //The generic connection to user's chosen I2C hardware
  uint8_t _i2caddr;
...
private:
  ...
  void _i2c_write(uint8_t *data, uint8_t len);
};
